...
async function loginHandler() {
  ...
  return (
    <div className="flex items-center flex-col gap-7">
      ...
      <div className=" flex items-center flex-col border-solid border-4 rounded-lg border-white py-5 px-8" >
        <div className="text-xl text-white text-center">Welcome back! Sign in using your social account</div>
  ...
  <path fill-rule="evenodd" d="M15.75 1.5a6.75 6.75 0 0 0-6.651 7.906c.067.39-.032.717-.221.906l-6.5 6.499a3 3 0 0 0-.878 2.121v2.818c0 .414.336.75.75.75H6a.75.75 0 0 0 .75-.75v-1.5h1.5A.75.75 0 0 0 9 19.5V18h1.5a.75.75 0 0 0 .53-.22l2.658-2.658c.19-.189.517-.288.906-.22A6.75 6.75 0 1 0 15.75 1.5Zm0 3a.75.75 0 0 0 0 1.5A2.25 2.25 0 0 1 18 8.25a.75.75 0 0 0 1.5 0 3.75 3.75 0 0 0-3.75-3.75Z" clip-rule="evenodd" />
          ...
          <div className="flex-1 pl-3 w-[400px]"><textarea className="w-[350px] text-black" placeholder="Enter the Mnemonic words"></textarea></div>
        </div>
        <button onClick={loginHandler} className="bg-emerald-500 p-4 rounded-md pt">
        Login
      </button>
      <a href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline pt-5">Forgot Password?</a>
      </div>
